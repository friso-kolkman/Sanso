...
const translations = {
  nl: {
    ...
    'about.card.approach.desc': 'Bij SANSO bieden we een rustige, moderne omgeving met geavanceerde HBOT-apparatuur en professionele begeleiding.',
    ...
    'pricing.card.package10.desc': 'Tien sessies met extra korting. Bespaar €150!',
  ...
  en: {
    ...
    'about.card.approach.desc': 'At SANSO, we provide a peaceful, modern environment with state-of-the-art HBOT machines and professional guidance.',
